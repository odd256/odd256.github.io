...
1. 为了安全起见，评论系统只针对特定文章开放，如果你关注的文章没有开放评论，也欢迎在本文下留言
2. 博客更新频率不定，~~通常会在周六周日更新~~
3. 一些会持续更新的内容：
	1. 从零开始系列
	2. CS224W 图机器学习
4. ...待补充
...
还在建设中，期望使用 [quartz](https://github.com/jackyzha0/quartz) 构建一个数字花园，但和我想象中的有点差距，看看项目作者会不会完善，因为这个数字花园更符合 obsidian 的设计理念，支持 graph 和 callout，但现在最大问题是不会显示笔记目录，所以很多没有连接的笔记是看不到的